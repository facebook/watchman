...
The relational expression accepts the same relational operators as described
in the [size term](size).
...
is detected as a case insensitive fileystem, `dirname` is equivalent to
`idirname`.
